...
public class Knn {
	 ...
	 * Try to run this double[][] p = {{0.5815037 , 0.2126437 , 0.2778553 , 0.9896006 , 0.7984958 , 0.7577199 , 0.0470290, 0.0615568, 0.3166059, 0.4474530},
	 ...
	 * double[][] q = {{1},{1},{10}}; 
	 * int k = 3; RealMatrix P = MatrixUtils.createRealMatrix(p); 
	 * RealMatrix Y = MatrixUtils.createRowRealMatrix(y1); 
	 * RealMatrix Q = MatrixUtils.createRealMatrix(q);
	 * 
